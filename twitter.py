...
class TwitterClient(object):
    ...
    def __init__(self, query, retweets_only=False, with_sentiment=False):
        ...
        consumer_key = os.environ['RgfsfL3DH62qhrNtWJjOdom6d']
        consumer_secret = os.environ['Cr7PRrD3Sxzh0IkcHU9Lkpw7Kh09CrlR3oAvvOFPGy70QJPVgU']
        access_token = os.environ[' 563793071-fx4uEgbcY4Znuix2PCMlf35AMMa059lJ7EvfMWOH']
        access_token_secret = os.environ['dJecuYhTQgEvQI3cPeXYiAKwFf1HxBFW5qoXabbqHJFON']
